                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td width="20%" class="text_right" style="color:<?=$acolor?>"><span class="">ทีม <?= $round['team_a_name']?></span></td>
                                    <td width="10%" class="text_center"><a class="btn btn-sm btn-success text-white"> <?= $round['score_a'] ?> : <?= $round['score_b'] ?> </a></td>
                                    <td width="20%" class="text_left" style="color:<?=$bcolor?>"> ทีม <?= $round['team_b_name'] ?></span></a></td>
                                    <td width="30%" class="text-right">
                                        <?php
                                        if( empty($round['score_a']) &&  empty($round['score_b']) ){
                                            ?>
